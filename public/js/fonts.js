/*
 ...
 MyFonts Webfont Build ID 3641975, 2018-09-14T14:12:53-0400
 ...
 License: https://www.myfonts.com/viewlicense?type=web&buildid=3641975
 Webfonts copyright: Copyright (c) 2012 by SoftMaker Software GmbH and its licensors. All rights reserved.

 ? 2018 MyFonts Inc
*/

var customPath = "/fonts/"; var protocol = document.location.protocol; "https:" != protocol && (protocol = "http:"); var count = document.createElement("script"); count.type = "text/javascript"; count.async = !0; count.src = protocol + "//hello.myfonts.net/count/379277"; var s = document.getElementsByTagName("script")[0]; s.parentNode.insertBefore(count, s); var browserName, browserVersion, webfontType; if ("undefined" == typeof woffEnabled) var woffEnabled = !0; var svgEnabled = 0, woff2Enabled = 1;
...
for (var fonts = [{ fontFamily: "TypewriterSerial-Italic", url: wfpath + "379277_0" + suffix + "_0." + webfontType }, { fontFamily: "TypewriterSerial-Medium", url: wfpath + "379277_1" + suffix + "_0." + webfontType }, { fontFamily: "TypewriterSerial-Xbold", url: wfpath + "379277_2" + suffix + "_0." + webfontType }, { fontFamily: "TypewriterSerial-Bold", url: wfpath + "379277_3" + suffix + "_0." + webfontType }, { fontFamily: "TypewriterSerial", url: wfpath + "379277_4" + suffix + "_0." + webfontType }], len = fonts.length, css = "", i = 0; i < len; i++) {
    var format = "svg#wf" == webfontType ?
        'format("svg")' : "ttf" == webfontType ? 'format("truetype")' : "eot" == webfontType ? "" : 'format("' + webfontType + '")', css = css + ("@font-face{font-family: " + fonts[i].fontFamily + ";src:url(" + fonts[i].url + ")" + format + ";"); fonts[i].fontWeight && (css += "font-weight: " + fonts[i].fontWeight + ";"); fonts[i].fontStyle && (css += "font-style: " + fonts[i].fontStyle + ";"); css += "}"
